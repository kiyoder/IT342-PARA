...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLifecycleRuntimeKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v241</b> with <b>androidx.lifecycle:lifecycle-runtime-ktx</b> coordinates and
         * with version reference <b>lifecycleRuntimeKtxVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV241() {
            return create("androidx.lifecycle.runtime.ktx.v241");
        }
    ...
    public static class GithubLibraryAccessors extends SubDependencyFactory {
        private final GithubSupabaseLibraryAccessors laccForGithubSupabaseLibraryAccessors = new GithubSupabaseLibraryAccessors(owner);

        public GithubLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.supabase</b>
         */
        public GithubSupabaseLibraryAccessors getSupabase() {
            return laccForGithubSupabaseLibraryAccessors;
        }

    }

    public static class GithubSupabaseLibraryAccessors extends SubDependencyFactory {

        public GithubSupabaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kt</b> with <b>io.github.jan.supabase:supabase-kt</b> coordinates and
         * with version reference <b>supabaseKtVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKt() {
            return create("github.supabase.kt");
        }
    ...
    public static class KotlinxCoroutinesAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v171</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-android</b> coordinates and
    ...
    public static class PlayServicesAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2050</b> with <b>com.google.android.gms:play-services-auth</b> coordinates and
         * with version reference <b>playServicesAuthVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2050() {
            return create("play.services.auth.v2050");
        }
    ...
    public static class SupabaseLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>gotrue</b> with <b>io.github.jan.supabase:gotrue</b> coordinates and
         * with version reference <b>gotrue</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
         ...
         * with version reference <b>supabaseKt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKt() {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>activityKtx</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>gotrue</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGotrue() { return getVersion("gotrue"); }

        /**
         * Version alias <b>gotrueKt</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxCoroutinesAndroidVersion</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleRuntimeKtxVersion</b> with value <b>2.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>osmdroidAndroid</b> with value <b>6.1.10</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesAuthVersion</b> with value <b>20.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesLocation</b> with value <b>18.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>supabaseKt</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSupabaseKt() { return getVersion("supabaseKt"); }

        /**
         * Version alias <b>supabaseKtVersion</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSupabaseKtVersion() { return getVersion("supabaseKtVersion"); }
